...
class BaseVisionAnalyzer:
    ...
    def __init__(self, model_name):
        ...
        self.selling_points_prompt = (
            """Identify the key selling points or unique features highlighted in this advertisement image.
For each selling point, explain why it is a selling point—what makes it appealing or important to potential customers?
Format your answer as a list, where each item includes the selling point and a brief justification."""
        )
    
    def analyze_image_selling_points(self, image_path):
...
def main():
    parser = argparse.ArgumentParser(description='Selling Points Vision Analyzer')
    ...
    print(f"📸 Selling Points Analyzer")
    ...
    for i, img_path in enumerate(selected_images, 1):
        ...
        result = analyzer.analyze_image_selling_points(img_path)
